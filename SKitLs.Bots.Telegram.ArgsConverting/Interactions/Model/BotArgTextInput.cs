...
namespace SKitLs.Bots.Telegram.ArgedInteractions.Interactions.Model
{
    public class BotArgTextInput<TArg> : DefaultTextInput, IArgedAction<TArg, SignedMessageTextUpdate> where TArg : notnull, new()
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="BotArgTextInput{TArg}"/> with specified data.
        /// </summary>
        ...
        public BotArgTextInput(string @base, BotArgedInteraction<TArg, SignedMessageTextUpdate> action, char splitToken = ' ') : base(@base)
        {
            Action = MiddleAction;
            ArgAction = action;
