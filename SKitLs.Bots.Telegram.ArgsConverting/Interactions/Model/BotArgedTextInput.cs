...
{
    /// <summary>
    /// Represents a text input action with argument support, derived from <see cref="DefaultTextInput"/>.
    ...
    public class BotArgedTextInput<TArg> : DefaultTextInput, IArgedAction<TArg, SignedMessageTextUpdate> where TArg : notnull, new()
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="BotArgedTextInput{TArg}"/> with specified data.
        /// </summary>
